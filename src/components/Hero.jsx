...
const Hero = () => {
  return (
    <div className='md:max-w-[1480px] max-w-[600px] m-auto w-full md:px-0 px-4 py-16'>
      <div className='h-[85vh] flex flex-col md:flex-row justify-between items-center md:px-10'>
