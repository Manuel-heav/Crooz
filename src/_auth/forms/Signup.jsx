...
<form>
    <div class="grid gap-6 mb-6 md:grid-cols-2 ">
        <div>
            <label for="first_name" class="block mb-2 text-sm font-medium text-gray-900 dark:">First Name</label>
        ...
        <div>
            <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:">Last Name</label>
        ...
        <div>
            <label for="phone" class="block mb-2 text-sm font-medium text-gray-900 dark:">Car Owner's Phone Number</label>
        ...
        <div>
            <label for="website" class="block mb-2 text-sm font-medium text-gray-900 dark:">Car Owner's Full Name</label>
        ...
        <div>
            <label for="visitors" class="block mb-2 text-sm font-medium text-gray-900 dark:">Vehicle Capacity</label>
    ...
    <div class="mb-6">
        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:">Email Address</label>
    ...
    <div class="mb-6">
        <label for="confirm_password" class="block mb-2 text-sm font-medium text-gray-900 dark:">Liscence Plate Number</label>
    ...
    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:">ID image/ Driving licence</label>
<input class="block w-full text-sm text-gray-900 border border-gray-300 rounded cursor-pointer bg-gray-50 p-2.5" aria-describedby="file_input_help" id="file_input" type="file"required/>
    ...
    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:">Car Ownership Libre / Rental Contract Image</label>
<input class="block w-full text-sm text-gray-900 border border-gray-300 rounded cursor-pointer bg-gray-50 p-2.5" aria-describedby="file_input_help" id="file_input" type="file"required/>
    ...
    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:">Car Owner ID Image</label>
<input class="block w-full text-sm text-gray-900 border border-gray-300 rounded cursor-pointer bg-gray-50 p-2.5" aria-describedby="file_input_help" id="file_input" type="file"required/>
    ...
    <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:">Vehicle Photo</label>
<input class="block w-full text-sm text-gray-900 border border-gray-300 rounded cursor-pointer bg-gray-50 p-2.5" aria-describedby="file_input_help" id="file_input" type="file"required/>
